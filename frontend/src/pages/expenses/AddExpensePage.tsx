    ...
    <AppShell>
      ...
      <PageTransition>
        <div className="max-w-2xl mx-auto px-4 py-6 flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-zinc-100">Add Expense</h2>
          <p className="text-sm text-gray-500 dark:text-zinc-400 max-w-xs">
            Full expense creation with equal, percentage, exact, shares, and itemized splits is coming in Phase 3.
          </p>
          <Button variant="secondary" onClick={() => navigate(`/g/${groupId}`)}>
            Back to group
          </Button>
        </div>
      </PageTransition>
