      ...
      <div className="fixed inset-x-0 bottom-0 z-50 sm:inset-0 sm:flex sm:items-center sm:justify-center p-4">
        ...
        >
          ...
          <div className="px-6 pt-6 pb-4">
            ...
            {/* Amount */}
            <div className="mb-4">
              <p className="text-xs font-medium text-gray-600 mb-1.5">Amount</p>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-8 pr-3.5 rounded-xl border border-gray-300 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                />
            ...
            {/* Note */}
            <div className="mb-6">
              <p className="text-xs font-medium text-gray-600 mb-1.5">Note <span className="text-gray-400 font-normal">(optional)</span></p>
              <input
                type="text"
                value={note}
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  p.confirmed_at ? 'bg-emerald-50' : 'bg-amber-50'
                )}
              >
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        ...
        {allSettled ? (
          <div className="flex flex-col items-center py-8 px-4 text-center">
            ...
            <p className="text-sm font-semibold text-gray-800">All settled up!</p>
          ...
          <div
            className={cn(
              ...
              netBalance > 0 ? 'bg-emerald-50' : netBalance < 0 ? 'bg-red-50' : 'bg-gray-50'
            )}
          >
            <p className="text-xs text-gray-500 mb-0.5">Your net balance</p>
            <p className={cn(
              'text-xl font-bold',
              netBalance > 0 ? 'text-emerald-600' : netBalance < 0 ? 'text-red-500' : 'text-gray-500'
            )}>
              {netBalance > 0 && '+'}
        ...
        {pendingConfirmations.length > 0 && (
          <div className="mx-4 mb-3 rounded-xl bg-amber-50 border border-amber-200 px-4 py-3">
            <p className="text-xs font-semibold text-amber-700 mb-2">Awaiting your confirmation</p>
              ...
              {iOwe.map((s) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold text-gray-800 truncate">{to?.name}</p>
        ...
        {owedToMe.length > 0 && (
          <div className={cn('px-4 pb-3', iOwe.length > 0 && 'pt-1')}>
            <p className="text-xs font-semibold text-emerald-600 mb-2">Owed to you</p>
            <div className="flex flex-col gap-2">
              {owedToMe.map((s) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-400 shrink-0 bg-white border border-gray-200 rounded-lg px-2 py-1">
                      owes you
                    </span>
                  </div>
                )
