      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="px-6 py-5 flex flex-col gap-5">
            ...
            {/* Currency — locked to INR for now, extensible later */}
            <div>
              <label className="text-sm font-medium text-gray-700 block mb-1.5">Currency</label>
              <div className="h-10 flex items-center px-3.5 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-500">
                ₹ Indian Rupee (INR)
              </div>
            </div>
