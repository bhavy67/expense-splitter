            ...
            {debts.map((debt, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* UPI / Remind button — swaps based on state */}
                  {isInr && !memberMap[debt.to]?.upiId ? (
                    // INR group but no UPI ID → WhatsApp remind
                    <button
                    ...
                    // Has UPI ID (active) OR non-INR (dimmed)
                    <button
                      ...
                      className={cn(
                        ...
                        isInr && memberMap[debt.to]?.upiId
                          ...
                          : 'bg-transparent text-[#4a4940]/50 dark:text-[#a09880]/50 border-[#0a0a0a]/15 dark:border-[#f0ede5]/15 cursor-pointer'
                      )}
                      title={!isInr ? `UPI only available for INR groups` : 'Pay via UPI'}
                    >
