    ...
    <div className="flex flex-col gap-3">
      ...
      {itemsTotal > 0 && (
        <p className="text-xs text-gray-500">
          Items total: <span className="font-semibold text-gray-800">{formatCurrency(itemsTotal)}</span>
          <span className="text-gray-400"> (becomes the expense total)</span>
        </p>
      )}
        ...
        <div key={item.id} className="border border-gray-200 rounded-2xl overflow-hidden">
          ...
          <div className="flex items-center gap-2 px-3 pt-3 pb-2">
            ...
            <input
              ...
              className="flex-1 text-sm font-medium text-gray-800 bg-transparent border-0 focus:outline-none placeholder:text-gray-300"
            />
            <div className="flex items-center gap-1 shrink-0">
              ...
              <input
                ...
                className="w-20 h-7 rounded-lg border border-gray-200 text-right pr-2 text-sm font-semibold text-gray-800 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
            <button
              type="button"
              ...
              className="p-1 rounded-lg text-gray-300 hover:text-red-400 hover:bg-red-50 disabled:opacity-30 transition-colors"
            >
          ...
          <div className="px-3 pb-3 border-t border-gray-100 pt-2">
            <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wide mb-2">Split between</p>
              ...
              {active.map((m) => {
                ...
                return (
                  ...
                  >
                    ...
                    {m.user.name.split(' ')[0]}
                    {perPerson && (
                      <span className="text-indigo-400 font-normal">·{formatCurrency(perPerson)}</span>
                    )}
                  </button>
                )
              })}
